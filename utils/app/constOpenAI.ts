...
export const OPENAI_API_VERSION =  'anthropic/claude-sonnet-4'//'2023-03-15-preview' || '2023-07-01-preview' ||   process.env.OPENAI_API_VERSION;//'2023-07-01-preview' is of azure gpt4
